...
/******/ 	var hotCurrentHash = "9286e3351360e4f013c6"; // eslint-disable-line no-unused-vars
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__components_Incrementer__ = __webpack_require__(6);
...
var MyComponent = function (_Component) {
    ...
    MyComponent.prototype.render = function render() {
        return Object(__WEBPACK_IMPORTED_MODULE_0_inferno__["createVNode"])(2, 'div', null, [Object(__WEBPACK_IMPORTED_MODULE_0_inferno__["createVNode"])(2, 'h1', null, 'Welcome to Inferno ' + __WEBPACK_IMPORTED_MODULE_0_inferno__["version"] + ' TSX ' + this.tsxVersion), Object(__WEBPACK_IMPORTED_MODULE_0_inferno__["createVNode"])(16, __WEBPACK_IMPORTED_MODULE_2__components_Incrementer__["a" /* Incrementer */], null, null, {
            'name': 'Crazy button'
        })]);
    };
...
Object(__WEBPACK_IMPORTED_MODULE_0_inferno__["render"])(Object(__WEBPACK_IMPORTED_MODULE_0_inferno__["createVNode"])(16, MyComponent), container);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__utils_math__ = __webpack_require__(7);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__Visualizer__ = __webpack_require__(8);
...
var Incrementer = function (_Component) {
    ...
    function Incrementer(props, context) {
        ...
        _this.doMath = function () {
            _this.setState({
                value: Object(__WEBPACK_IMPORTED_MODULE_1__utils_math__["a" /* addOne */])(_this.state.value)
            });
        };
        return _this;
    }
    ...
    Incrementer.prototype.render = function render() {
        ...
        // this.props.name = 1;
        // this.props.bar = 1;
        return Object(__WEBPACK_IMPORTED_MODULE_3_inferno__["createVNode"])(2, 'div', null, [this.props.name, Object(__WEBPACK_IMPORTED_MODULE_3_inferno__["createVNode"])(2, 'button', null, 'Increment', {
            'onClick': this.doMath
        }), Object(__WEBPACK_IMPORTED_MODULE_3_inferno__["createVNode"])(16, __WEBPACK_IMPORTED_MODULE_2__Visualizer__["a" /* Visualizer */], null, null, {
            'number': this.state.value + 'foobar'
        })]);
    };
...
function Visualizer(_ref) {
  ...
  return Object(__WEBPACK_IMPORTED_MODULE_0_inferno__["createVNode"])(2, "div", "visualizer", number);
}
